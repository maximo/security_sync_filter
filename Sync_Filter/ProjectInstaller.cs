...
namespace Sync_Filter
{
    ...
    {
        string serviceName = "sync_filter";
        ...
        public override void Install(IDictionary stateSaver)
        {
            ...
            try
            {
                ...
                System.Diagnostics.Trace.WriteLine("\t\tSQL account: [" + _sql.UserID + "]");
                _sql.Password = this.Context.Parameters["password"].ToString();
                System.Diagnostics.Trace.WriteLine("\t\tSQL password: [" + _sql.Password + "]");
                ...
                System.Diagnostics.Trace.WriteLine("\t\tSQL failover: [" + _sql.FailoverPartner + "]");
            }
            catch
            {
                // do nothing.
            ...
            // interval between syncs of AD information to database.
            try
            {
                _config.AppSettings.Settings["interval"].Value = this.Context.Parameters["interval"].ToString();
            }
            catch
            {
                _config.AppSettings.Settings.Add("interval", this.Context.Parameters["interval"].ToString());
            }
            ...
            try
            {
                _config.AppSettings.Settings["logLevel"].Value = "normal";
            }
            catch
            {
                _config.AppSettings.Settings.Add("logLevel", "normal");
            }
